...
<template>
  ...
  >
    <SwitchThumb
      :class="cn('pointer-events-none block h-5 w-5 rounded-full bg-white shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5 dark:bg-slate-950')"
    >
      <slot name="thumb" />
    </SwitchThumb>
  </SwitchRoot>
